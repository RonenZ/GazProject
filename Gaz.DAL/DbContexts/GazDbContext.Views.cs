...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(Gaz.DAL.DbContexts.GazDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets265bee2d8e2109a221a91f2de751db8fb49302117ebe4c27898f0935d4366eae))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets265bee2d8e2109a221a91f2de751db8fb49302117ebe4c27898f0935d4366eae : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "265bee2d8e2109a221a91f2de751db8fb49302117ebe4c27898f0935d4366eae"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "GazDbContext.Addresses")
            {
                return GetView9();
            }

            if (extentName == "GazDbContext.Counters")
            {
                return GetView10();
            }

            if (extentName == "GazDbContext.CounterReads")
            {
                return GetView11();
            }

            if (extentName == "GazDbContext.UserBills")
            {
                return GetView12();
            }

            if (extentName == "GazDbContext.UserComplaints")
            {
                return GetView13();
            }

            if (extentName == "GazDbContext.Users")
            {
                return GetView14();
            }

            if (extentName == "GazDbContext.UserNotifications")
            {
                return GetView15();
            }

            if (extentName == "GazDbContext.UserRoles")
            {
                return GetView16();
            }

            if (extentName == "GazDbContext.User_User_Counters")
            {
                return GetView17();
            }
    ...
    SELECT VALUE -- Constructing Address
        [CodeFirstDatabaseSchema.Address](T1.Address_AddressID, T1.Address_CityName, T1.Address_StreetName, T1.Address_HouseNumber, T1.Address_ApartmentNumber, T1.Address_latitude, T1.Address_longitude)
    FROM (
        SELECT 
            T.ID AS Address_AddressID, 
            ...
            True AS _from0
        FROM GazDbContext.Addresses AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing Counter
        [CodeFirstDatabaseSchema.Counter](T1.Counter_CounterID, T1.Counter_AddressID)
    FROM (
        SELECT 
            T.ID AS Counter_CounterID, 
            T.AddressID AS Counter_AddressID, 
            True AS _from0
        FROM GazDbContext.Counters AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing CounterRead
        [CodeFirstDatabaseSchema.CounterRead](T1.CounterRead_ReadID, T1.CounterRead_CounterID, T1.CounterRead_CreateTime, T1.CounterRead_ReadAmount)
    FROM (
        SELECT 
            T.ID AS CounterRead_ReadID, 
            T.CounterID AS CounterRead_CounterID, 
            T.CreateTime AS CounterRead_CreateTime, 
            T.ReadAmount AS CounterRead_ReadAmount, 
            True AS _from0
        FROM GazDbContext.CounterReads AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing UserBill
        [CodeFirstDatabaseSchema.UserBill](T1.UserBill_BillID, T1.UserBill_BillAmount, T1.UserBill_CreateTime, T1.UserBill_CounterID, T1.UserBill_Payed)
    FROM (
        SELECT 
            T.ID AS UserBill_BillID, 
            ...
            True AS _from0
        FROM GazDbContext.UserBills AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing UserComplaint
        [CodeFirstDatabaseSchema.UserComplaint](T1.UserComplaint_ComplaintID, T1.UserComplaint_ComplaintDescription, T1.UserComplaint_UserID, T1.UserComplaint_CounterID, T1.UserComplaint_CreateTime, T1.UserComplaint_Disable)
    FROM (
        SELECT 
            T.ID AS UserComplaint_ComplaintID, 
            ...
            True AS _from0
        FROM GazDbContext.UserComplaints AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing UserNotification
        [CodeFirstDatabaseSchema.UserNotification](T1.UserNotification_NotificationID, T1.UserNotification_NotificationDescription, T1.UserNotification_UserID, T1.UserNotification_CreateTime, T1.UserNotification_Disabled)
    FROM (
        SELECT 
            T.ID AS UserNotification_NotificationID, 
            ...
            True AS _from0
        FROM GazDbContext.UserNotifications AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing UserRole
        [CodeFirstDatabaseSchema.UserRole](T1.UserRole_RoleID, T1.UserRole_RoleDescription)
    FROM (
        SELECT 
            T.ID AS UserRole_RoleID, 
            T.RoleDescription AS UserRole_RoleDescription, 
            True AS _from0
        FROM GazDbContext.UserRoles AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazDbContext.User_User_Counters AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for GazDbContext.Addresses.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazDbContext.Counters.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazDbContext.CounterReads.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazDbContext.UserBills.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazDbContext.UserComplaints.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        SELECT 
            T.ComplaintID AS UserComplaint_ID, 
            T.ComplaintDescription AS UserComplaint_ComplaintDescription, 
            T.UserID AS UserComplaint_UserID, 
            T.CounterID AS UserComplaint_CounterID, 
            T.CreateTime AS UserComplaint_CreateTime, 
        ...
        /// <summary>
        /// Gets the view for GazDbContext.Users.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazDbContext.UserNotifications.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        SELECT 
            T.NotificationID AS UserNotification_ID, 
            T.NotificationDescription AS UserNotification_NotificationDescription, 
            T.UserID AS UserNotification_UserID, 
            T.CreateTime AS UserNotification_CreateTime, 
            T.Disabled AS UserNotification_Disabled, 
        ...
        /// <summary>
        /// Gets the view for GazDbContext.UserRoles.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazDbContext.User_User_Counters.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        SELECT -- Constructing User_User_Counters_Source
            CreateRef(GazDbContext.Users, row(T2.[User_User_Counters.User_User_Counters_Source.ID]), [Gaz.DAL.DbContexts.User]) AS [User_User_Counters.User_User_Counters_Source], 
        ...
        FROM (
            SELECT -- Constructing User_User_Counters_Target
                ...
                CreateRef(GazDbContext.Counters, row(T1.[User_User_Counters.User_User_Counters_Target.ID]), [Gaz.DAL.DbContexts.Counter]) AS [User_User_Counters.User_User_Counters_Target]
            FROM (
                SELECT 
