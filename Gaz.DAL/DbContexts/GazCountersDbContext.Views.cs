...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(Gaz.DAL.DbContexts.GazCountersDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsb52afef11bf0a37b40afa9eed5a84db55332dacc3a5b88ce19ea025a42475a02))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySetsb52afef11bf0a37b40afa9eed5a84db55332dacc3a5b88ce19ea025a42475a02 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "b52afef11bf0a37b40afa9eed5a84db55332dacc3a5b88ce19ea025a42475a02"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "GazCountersDbContext.Addresses")
            {
                return GetView9();
            }

            if (extentName == "GazCountersDbContext.Counters")
            {
                return GetView10();
            }

            if (extentName == "GazCountersDbContext.CounterReads")
            {
                return GetView11();
            }

            if (extentName == "GazCountersDbContext.UserBills")
            {
                return GetView12();
            }

            if (extentName == "GazCountersDbContext.UserComplaints")
            {
                return GetView13();
            }

            if (extentName == "GazCountersDbContext.Users")
            {
                return GetView14();
            }

            if (extentName == "GazCountersDbContext.UserNotifications")
            {
                return GetView15();
            }

            if (extentName == "GazCountersDbContext.UserRoles")
            {
                return GetView16();
            }

            if (extentName == "GazCountersDbContext.User_User_Counters")
            {
                return GetView17();
            }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.Addresses AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.Counters AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.CounterReads AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.UserBills AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.UserComplaints AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.Users AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.UserNotifications AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.UserRoles AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazCountersDbContext.User_User_Counters AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for GazCountersDbContext.Addresses.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.Counters.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.CounterReads.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.UserBills.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.UserComplaints.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.Users.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.UserNotifications.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.UserRoles.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazCountersDbContext.User_User_Counters.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        SELECT -- Constructing User_User_Counters_Source
            CreateRef(GazCountersDbContext.Users, row(T2.[User_User_Counters.User_User_Counters_Source.ID]), [Gaz.DAL.DbContexts.User]) AS [User_User_Counters.User_User_Counters_Source], 
        ...
        FROM (
            SELECT -- Constructing User_User_Counters_Target
                ...
                CreateRef(GazCountersDbContext.Counters, row(T1.[User_User_Counters.User_User_Counters_Target.ID]), [Gaz.DAL.DbContexts.Counter]) AS [User_User_Counters.User_User_Counters_Target]
            FROM (
                SELECT 
