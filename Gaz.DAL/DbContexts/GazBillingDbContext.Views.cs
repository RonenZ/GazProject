...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(Gaz.DAL.DbContexts.GazBillingDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets5ecb85c8c9830e13fbd38ed40cd3254c0a22a06c5644db1510c743bac648fb68))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets5ecb85c8c9830e13fbd38ed40cd3254c0a22a06c5644db1510c743bac648fb68 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "5ecb85c8c9830e13fbd38ed40cd3254c0a22a06c5644db1510c743bac648fb68"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "GazBillingDbContext.Counters")
            {
                return GetView9();
            }

            if (extentName == "GazBillingDbContext.Addresses")
            {
                return GetView10();
            }

            if (extentName == "GazBillingDbContext.CounterReads")
            {
                return GetView11();
            }

            if (extentName == "GazBillingDbContext.UserBills")
            {
                return GetView12();
            }

            if (extentName == "GazBillingDbContext.UserComplaints")
            {
                return GetView13();
            }

            if (extentName == "GazBillingDbContext.Users")
            {
                return GetView14();
            }

            if (extentName == "GazBillingDbContext.UserNotifications")
            {
                return GetView15();
            }

            if (extentName == "GazBillingDbContext.UserRoles")
            {
                return GetView16();
            }

            if (extentName == "GazBillingDbContext.User_User_Counters")
            {
                return GetView17();
            }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.Counters AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.Addresses AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.CounterReads AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.UserBills AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.UserComplaints AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.Users AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.UserNotifications AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.UserRoles AS T
    ) AS T1");
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM GazBillingDbContext.User_User_Counters AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for GazBillingDbContext.Counters.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.Addresses.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.CounterReads.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.UserBills.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.UserComplaints.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.Users.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.UserNotifications.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.UserRoles.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for GazBillingDbContext.User_User_Counters.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        SELECT -- Constructing User_User_Counters_Source
            CreateRef(GazBillingDbContext.Users, row(T2.[User_User_Counters.User_User_Counters_Source.ID]), [Gaz.DAL.DbContexts.User]) AS [User_User_Counters.User_User_Counters_Source], 
        ...
        FROM (
            SELECT -- Constructing User_User_Counters_Target
                ...
                CreateRef(GazBillingDbContext.Counters, row(T1.[User_User_Counters.User_User_Counters_Target.ID]), [Gaz.DAL.DbContexts.Counter]) AS [User_User_Counters.User_User_Counters_Target]
            FROM (
                SELECT 
